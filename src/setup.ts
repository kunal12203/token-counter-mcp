...
function writeStopHookPowershell() {
  ...
  const lines = [
    ...
    "            try { $msg = $allLines[$i] | ConvertFrom-Json -ErrorAction SilentlyContinue } catch { continue }",
